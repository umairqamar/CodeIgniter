        ...
        <div class="col-md-12 " >
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Add Training Entry : <?php echo $employee->result()['0']->name;?></h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="training" name="training" placeholder="Enter Training Name" required>
                    </div>
